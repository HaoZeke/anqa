...
def resolve_session_locator(
    ...
    *,
    ...
    :func:`list_session_catalog` or a full store listing.
...
def resolve_session_reference(
    ...
    *,
    ...
    Name lookup only on :func:`catalog_scan_roots` (direct child or one
    encoded-cwd bucket). Does not list every sibling or load list-meta.
    ``session/overview`` and ``session/timeline`` use this when the warm
    catalog has not yet indexed the id.
