...
from anqa.models import JsonObject, JsonValue, as_json_object
...
class Keymap:
    ...
    :ivar path: Path that was consulted (``ANQA_KEYS`` or APP_HOME).
...
def resolve_keys_path() -> Path:
    """Return the overlay path: ``ANQA_KEYS`` if set, else APP_HOME/keys.toml.
